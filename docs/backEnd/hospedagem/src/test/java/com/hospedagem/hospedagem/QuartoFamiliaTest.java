...
public class QuartoFamiliaTest {
    ...
    QuartoFamilia quartoFamilia = new QuartoFamilia("Familia", 100, true, true, 3, 2, TipoCama.COMUM, 2, 150);
    QuartoFamilia quartoFamiliaKing = new QuartoFamilia("Familia", 100, true, true, 3, 2, TipoCama.KING, 3, 200);
